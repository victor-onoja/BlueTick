...
Gradient linearWhiteGradient = LinearGradient(
    begin: Alignment.topCenter,
    end: Alignment.bottomCenter,
    stops: linearWhiteStops,
    colors: _linearWhite);
...
final TextStyle _style1 =
    TextStyle(fontSize: 16, fontWeight: FontWeight.w600, color: mainBlue);

final TextStyle _style2 =
    TextStyle(fontSize: 16, fontWeight: FontWeight.w600, color: blue2);

final TextStyle _style3 =
    TextStyle(fontSize: 16, fontWeight: FontWeight.w700, color: darkBlue2);

final TextStyle _style4 =
    TextStyle(fontSize: 16, fontWeight: FontWeight.w700, color: mainBlue);

const TextStyle _style5 = TextStyle(fontWeight: FontWeight.w600, fontSize: 24);

final TextStyle _style6 =
    TextStyle(color: mainBlue, fontWeight: FontWeight.w600, fontSize: 24);
