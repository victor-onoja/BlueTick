...
class verifyWorkspace extends StateNotifier<LoginState> {
  Reader reader;
  verifyWorkspace(this.reader) : super(LoginState());

  void checkingIsLoading() {
    state = state.update(!state.isLoading);
  }

  Future<Either<ErrorModel, VerifyWorkspaceresponse>> verifyWorkspacerequest(
